...
public partial class MIS316_examples_strings : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        // concatenating strings with numeric data types
        try // must try/catch because of the conversion
        {
            ...
            // output the message
            lblMessage.Text = "Your name is: " + strName + "<br />" + "You entered: " + decNumber;
        }
        catch (Exception)
        {
